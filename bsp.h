...
#define DMA_SDRAM_READ_LATENCY 3
#define DMA_SRC_LAT_SDRAM (DMA_SDRAM_READ_LATENCY << 4)
#define DMA_SRC_LAT_SDRAM_WITH_ARBITER ((DMA_SDRAM_READ_LATENCY + 1) << 4)
#define DMA_SRC_LAT_SDRAM_WITH_DMA_PIPELINE ((DMA_SDRAM_READ_LATENCY + 2) << 4)
