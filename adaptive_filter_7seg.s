...
call MIN; call 25
pop r1; r1 <- 14: step=MIN(0.5/squared norm,1E4), this value is removed from program stack
...
lw [r3 + FP_2_OFFSET] r6; 15: r6<- x"40000000", carrega a cte 2.0, da memória de instrução
